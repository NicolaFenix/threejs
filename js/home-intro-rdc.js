        ...
        loadModel: function () {
            ...
            loader.load(modelPath, function (collada) {
                ...
                function processArray( array ) {
                    ...
                    var forbiddenNames = ['corri0','corri1','corri2','corri3','corri4','Light', 'Plane', 'Camera', 'Nullo', 'group1_pPlane8','mare','triangolo1',
                        'triangolo2','triangolo3','triangolo4','freccia','bastone', 'canazzo',
                        'torre01', 'torre02', 'torre03', 'torre04', 'Camera.Target.1', 'Camera.1', 'tri', 'terreno', 'montagna', 'ponte'
